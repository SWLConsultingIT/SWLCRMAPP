...
export default async function ResultsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 w-full">
      {/* Hero — shared Aurora hero (boss-approved 2026-08-27): outcomes summary
          chips (positive · lost · discarded · renurture). */}
      <AuroraHero
        ...
        kpis={[
          ...
          { label: t("results.tab.lost"), value: lostLeads.length, tone: "red" },
          { label: t("results.tab.discarded"), value: discardedLeads.length },
          { label: t("results.tab.renurture"), value: renurturingLeads.length, tone: "gold" },
        ]}
      />
      <ResultsClient
