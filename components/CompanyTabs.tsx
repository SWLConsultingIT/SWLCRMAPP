...
export default function CompanyTabs({
  ...
  return (
    <>
      <div className="flex items-center gap-6 px-6 border-t overflow-x-auto" style={{ borderColor: C.border }}>
        {tabs.map((tab, i) => (
          <button
            key={tab.label}
            onClick={() => setActive(i)}
            className="text-sm font-medium py-3 relative transition-colors whitespace-nowrap"
