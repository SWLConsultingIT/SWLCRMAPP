...
// Standalone table for the Opportunities (won leads) dataset. Lives in
// /components so it can be reused both at /opportunities (with its own
// PageHero) and inside /leads → Results → Won (no hero, just the table).
// Lifted out of app/opportunities/OpportunitiesClient.tsx so both surfaces
// share one renderer.
